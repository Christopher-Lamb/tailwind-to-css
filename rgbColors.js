const rgbColorMap = {
  ...
  "rose-900": "136 19 55",
  "rose-950": "76 5 25",
  primary: "var(--primaryRGB)",
  "primary-text": "var(--primary-textRGB)",
  secondary: "var(--secondaryRGB)",
  "secondary-text": "var(--secondary-textRGB)",
  third: "var(--thirdRGB)",
  "third-text": "var(--third-textRGB)",
  fourth: "var(--fourthRGB)",
  "fourth-text": "var(--fourth-textRGB)",
  accent: "var(--accentRGB)",
  "accent-text": "var(--accent-textRGB)",
  background: "var(--backgroundRGB)",
  "background-text": "var(--background-textRGB)",
};

const getRGB = (key) => {
  if (key in rgbColorMap) {
    return rgbColorMap[key];
  }
